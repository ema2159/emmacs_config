...
(add-hook 'magit-mode-hook 'tabbar-local-mode)
(add-hook 'magit-wip-mode-hook 'tabbar-local-mode)
(add-hook 'magit-blob-mode-hook 'tabbar-local-mode)
(add-hook 'magit-diff-mode-hook 'tabbar-local-mode)
(add-hook 'magit-file-mode-hook 'tabbar-local-mode)
(add-hook 'magit-refs-mode-hook 'tabbar-local-mode)
(add-hook 'magit-blame-mode-hook 'tabbar-local-mode)
(add-hook 'magit-popup-mode-hook 'tabbar-local-mode)
(add-hook 'magit-stash-mode-hook 'tabbar-local-mode)
(add-hook 'magit-cherry-mode-hook 'tabbar-local-mode)
(add-hook 'magit-reflog-mode-hook 'tabbar-local-mode)
...
(add-hook 'magit-repolist-mode-hook 'tabbar-local-mode)
(add-hook 'magit-revision-mode-hook 'tabbar-local-mode)
(add-hook 'magit-log-select-mode-hook 'tabbar-local-mode)
(add-hook 'magit-popup-help-mode-hook 'tabbar-local-mode)
(add-hook 'magit-auto-revert-mode-hook 'tabbar-local-mode)
(add-hook 'magit-merge-preview-mode-hook 'tabbar-local-mode)
(add-hook 'magit-submodule-list-mode-hook 'tabbar-local-mode)
(add-hook 'magit-wip-after-save-mode-hook 'tabbar-local-mode)
(add-hook 'magit-blame-read-only-mode-hook 'tabbar-local-mode)
(add-hook 'magit-wip-after-apply-mode-hook 'tabbar-local-mode)
(add-hook 'magit-wip-before-change-mode-hook 'tabbar-local-mode)
(add-hook 'magit-wip-initial-backup-mode-hook 'tabbar-local-mode)
(add-hook 'magit-wip-after-save-mode-hook 'tabbar-local-mode)
