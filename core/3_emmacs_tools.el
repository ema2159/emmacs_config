  ...
  (with-eval-after-load 'all-the-icons
    ...
    (setq company-box-icons-all-the-icons
	  `((Unknown . ,(all-the-icons-material "find_in_page" :height 0.9 :v-adjust -0.2))
	    ...
	    (Method . ,(all-the-icons-faicon "cube" :height 0.85 :v-adjust -0.05 :face 'font-lock-function-name-face))
	    (Function . ,(all-the-icons-faicon "cube" :height 0.85 :v-adjust -0.05 :face 'font-lock-function-name-face))
	    (Constructor . ,(all-the-icons-faicon "cube" :height 0.85 :v-adjust -0.05 :face 'font-lock-function-name-face))
	    (Field . ,(all-the-icons-faicon "tag" :height 0.85 :v-adjust -0.05 :face 'font-lock-variable-name-face))
	    (Variable . ,(all-the-icons-faicon "tag" :height 0.85 :v-adjust -0.05 :face 'font-lock-variable-name-face))
	    (Class . ,(all-the-icons-material "settings_input_component" :height 0.9 :v-adjust -0.2 :face 'font-lock-type-face))
	    (Interface . ,(all-the-icons-material "share" :height 0.9 :v-adjust -0.2 :face 'font-lock-variable-name-face))
	    (Module . ,(all-the-icons-material "view_module" :height 0.9 :v-adjust -0.2 :face 'font-lock-variable-name-face))
	    (Property . ,(all-the-icons-faicon "wrench" :height 0.85 :v-adjust -0.05))
	    (Unit . ,(all-the-icons-material "settings_system_daydream" :height 0.9 :v-adjust -0.2))
	    (Value . ,(all-the-icons-material "format_align_right" :height 0.9 :v-adjust -0.2 :face 'font-lock-variable-name-face))
	    (Enum . ,(all-the-icons-material "storage" :height 0.9 :v-adjust -0.2 :face 'font-lock-type-face))
	    ...
	    (EnumMember . ,(all-the-icons-material "format_align_right" :height 0.9 :v-adjust -0.2 :face 'font-lock-variable-name-face))
	    (Constant . ,(all-the-icons-faicon "square-o" :height 0.9 :v-adjust -0.05))
	    (Struct . ,(all-the-icons-material "settings_input_component" :height 0.9 :v-adjust -0.2 :face 'font-lock-type-face))
	    (Event . ,(all-the-icons-faicon "bolt" :height 0.85 :v-adjust -0.05 :face 'font-lock-type-face))
